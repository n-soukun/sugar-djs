...
import { encodeId } from './custom-id.js';
...
export interface CommandData<TParms extends CommandBuilderParms> extends BaseWrapperReturnData<TParms['_interaction']> {
	...
	autocomplete: AutocompleteProcess | undefined;
	middlewares: Middleware<TParms['_interaction']>[];
...
export interface ComponentData<TParms extends ComponentBuilderParms> extends BaseWrapperReturnData<
	TParms['_interaction']
> {
	args: TParms['_args'];
	customId: string;
